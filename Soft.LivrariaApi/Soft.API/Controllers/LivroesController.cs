...
namespace Soft.API.Controllers
{
    public class LivroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LivroId,Titulo,Autor,Situacao")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LivroId,Titulo,Autor,Situacao")] Livro livro)
        {
            if (ModelState.IsValid)
            {
